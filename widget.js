...
cpdefine("inline:com-chilipeppr-widget-dxf", ["chilipeppr_ready", /* other dependencies here */ ], function() {
    return {
        ...
        setupDragDrop: function () {
            ...
            chilipeppr.subscribe("/com-chilipeppr-elem-dragdrop/ondropped", this, this.onDXFDropped, 8); // default is 10, we do 9 to be higher priority
        },
        dxf: null, // contains the DXF Object
        
        onDXFDropped: function (data, info) {
